package com.candra.core.data.source.local

import com.candra.core.data.source.local.entity.TourismEntity
import com.candra.core.data.source.local.room.TourismDao
